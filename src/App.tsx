      ...
      {showPopup && (
        <div
          style={{
            ...
            background: "rgba(255, 255, 255, 0.1)", // 透明玻璃拟态效果
            backdropFilter: "blur(10px)", // 玻璃毛玻璃效果
            color: "white",
            padding: "20px",
            borderRadius: "12px",
            boxShadow: "0 4px 12px rgba(255, 255, 255, 0.2)", // 柔和光晕效果
            fontSize: "18px",
            textAlign: "center",
            width: "400px",
            display: "flex",
            ...
            zIndex: 9999, // 确保在最前面
            border: "1px solid rgba(255, 255, 255, 0.3)", // 轻微边框，让轮廓更清晰
